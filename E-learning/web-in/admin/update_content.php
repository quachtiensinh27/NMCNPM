...
if(isset($_POST['update'])){
   ...
   if(!empty($thumb)){
      if($thumb_size > 2000000){
         $message[] = 'Khích thước ảnh quá to!';
      }else{
...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Tên <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Nhập tên video" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Mô tả <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Nội dung mô tả" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Khóa học</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--chọn khóa học</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>Chưa có khóa học!</option>';
         }
         ?>
      </select>
      ...
      <input type="submit" value="Cập nhật" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Xem video</a>
         <input type="submit" value="Xóa" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Không tìm thấy video! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
