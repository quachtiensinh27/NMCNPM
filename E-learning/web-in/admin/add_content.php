...
<section class="video-form">
   ...
   <h1 class="heading">Cập nhật nội dung</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Tên video <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Nhập tên video" class="box">
      <p>Mô tả: <span>*</span></p>
      ...
      <select name="playlist" class="box" required>
         ...
         <?php
            ...
            echo '<option value="" disabled>Chưa có khóa học nào!</option>';
         }
         ?>
      </select>
      <p>Chọn hình nền <span>*</span></p>
      <input type="file" name="thumb" accept="image/*" required class="box">
      <p>Chọn video <span>*</span></p>
      <input type="file" name="video" accept="video/*" required class="box">
      <input type="submit" value="Tải video lên" name="submit" class="btn">
   </form>
