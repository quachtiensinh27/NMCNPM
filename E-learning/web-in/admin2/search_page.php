...
<section class="contents">
   ...
   <?php
      if(isset($_POST['search']) || isset($_POST['search_btn']) || isset($_POST['toggle_status']) || isset($_POST['delete_video']) || isset($_POST['delete_playlist'])){
         $search = $_POST['search'] ?? '';
      $select_videos = $conn->prepare("SELECT * FROM `content` WHERE title LIKE ? ORDER BY date DESC");
      $select_videos->execute(["%{$search}%"]);
