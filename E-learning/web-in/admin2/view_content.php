   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="hidden" name="current_status" value="<?= $fetch_content['status']; ?>">
            <button type="submit" name="toggle_status" class="option-btn" status="<?= $fetch_content['status']; ?>" onclick="return confirm('Bạn có chắc chắn muốn thay đổi trạng thái video này?');">
            <?= ($fetch_content['status'] == 'Mở') ? 'Khóa' : 'Mở'; ?>
            </button>
