...
if (isset($_POST['update_status'])) {
    ...
    $message[] = 'User status updated to ' . $state . '!';
}
...
<section class="user-management">
    ...
    <div class="filter-buttons">
        <a href="user_manage.php" class="btn">All Students</a>
        <a href="user_manage.php?filter=paid" class="btn">Paid Students</a>
        <a href="user_manage.php?filter=unpaid" class="btn">Unpaid Students</a>
    </div>
...
.user-management .filter-buttons .btn {
   flex: 0 0 10%; /* Đặt độ rộng khoảng 15% */
   padding: 0.6rem 1.2rem;
   font-size: 1.4rem;
   background:rgb(59, 102, 195);
   color:  #fefefe;
   border: none;
   border-radius: 5px;
   cursor: pointer;
